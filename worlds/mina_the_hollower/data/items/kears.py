...
class SingleKears(ItemTypeEnum):
    ...
    ASTRAL_ORREY_MIRROR_ROOM_RIGHT_SIDE_KEAR = ("Astral Orrey Mirror Room Right Side Lock", ITEMS_OFFSET_KEARS + 277, ItemClassification.progression)
    ASTRAL_ORREY_MIRROR_ROOM_LEFT_SIDE_KEAR = ("Astral Orrey Mirror Room Left Side Lock", ITEMS_OFFSET_KEARS + 278, ItemClassification.progression)
    ...
    LONERS_LANDING_BOARDWALK_KEAR = ("Loner's Landing Boarkwalk Lock", ITEMS_OFFSET_KEARS + 19, ItemClassification.progression)
