...
collectable_locations: dict[str, LocationData] = {
    "AO Mirror's End Red Switch Chest": LocationData(281, "Astral Orrery Mirror's End", Has(AstralPlatforms.RED_ASTRAL_PLATFORMS.value) & CanBurrow()),
    "AO Mirror's End Dr. Naught Reward": LocationData(276, "Astral Orrery Mirror's End", CanJumpTiles(distance=3) & CanCarry() &
                                                      HasKear(kear=SingleKears.ASTRAL_ORREY_MIRROR_ROOM_RIGHT_SIDE_KEAR.value)),
    "AO Mirror's End Locked Trinket Bag": LocationData(279, "Astral Orrery Mirror's End",
