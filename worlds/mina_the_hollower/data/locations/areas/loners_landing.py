...
collectable_locations: dict[str, LocationData] = {
    ...
    "LL Belowdecks Left Unchosen Weapon": LocationData(17, "Loner's Landing Belowdecks Chests", HasKear(kear=SingleKears.LONERS_LANDING_BELOWDECKS_LEFT_WEAPON_KEAR.value)),
