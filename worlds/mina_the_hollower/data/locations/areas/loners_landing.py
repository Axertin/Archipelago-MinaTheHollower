...
collectable_locations: dict[str, LocationData] = {
    ...
    "LL Belowdecks Right Unchosen Weapon": LocationData(18, "Loner's Landing Belowdecks Chests", HasKear(kear=SingleKears.LONERS_LANDING_BELOWDECKS_RIGHT_WEAPON_KEAR.value))),
