...
collectable_locations: dict[str, LocationData] = {
    ...
    "LL Boardwalk Sandwater Ledge Chest": LocationData(324, "Loner's Landing Boardwalk Sandfalls Ledge", item_rule=lambda item: item.name != Wallets.WALLET_SIZE.value),
    "LL Fish Trigger Antennae": LocationData(32, "Loner's Landing Boat Side", HasFishingRod() & CanBurrow()),
    "LL Belowdecks Left Unchosen Weapon": LocationData(17, "Loner's Landing Belowdecks", HasKear(kear=SingleKears.LONERS_LANDING_BELOWDECKS_LEFT_WEAPON_KEAR.value) & HasKear(kear=SingleKears.LONERS_LANDING_BELOWDECKS_BACK_KEAR.value)),
    "LL Belowdecks Right Unchosen Weapon": LocationData(18, "Loner's Landing Belowdecks", HasKear(kear=SingleKears.LONERS_LANDING_BELOWDECKS_RIGHT_WEAPON_KEAR.value) & HasKear(kear=SingleKears.LONERS_LANDING_BELOWDECKS_BACK_KEAR.value)),
