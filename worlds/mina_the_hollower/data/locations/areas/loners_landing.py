...
collectable_locations: dict[str, LocationData] = {
    ...
    "LL Boardwalk Sandfalls Ledge Chest": LocationData(324, "Loner's Landing Boardwalk Sandfalls Ledge", item_rule=lambda item: item.name != Wallets.WALLET_SIZE.value),
    # needs bounce,
