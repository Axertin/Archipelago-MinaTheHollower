...
collectable_locations: dict[str, LocationData] = {
        ...
        "OS Courtyard East Deboning Wand" : LocationData(161, "Ossex Courtyard East", ShopPrice(cost=1000), item_rule=lambda item: item.name != Wallets.value),
        ...
        "OS Couple's Quarter Chest" : LocationData(165, "Ossex Couple's Quarter", CanBurrow() | HasReachingSideArm(), item_rule=lambda item: item.name != Wallets.value),
        ...
        "OS Kear Institute Kear #1" : LocationData(199, "Ossex Kear Institute", ShopPrice(cost=300), item_rule=lambda item: item.name != Wallets.value),
        "OS Kear Institute Kear #2" : LocationData(200, "Ossex Kear Institute", ShopPrice(cost=500), item_rule=lambda item: item.name != Wallets.value),
        "OS Kear Institute Kear #3" : LocationData(201, "Ossex Kear Institute", ShopPrice(cost=750), item_rule=lambda item: item.name != Wallets.value),
        "OS Kear Institute Kear #4" : LocationData(202, "Ossex Kear Institute", ShopPrice(cost=875), item_rule=lambda item: item.name != Wallets.value),
        "OS Kear Institute Kear #5" : LocationData(203, "Ossex Kear Institute", ShopPrice(cost=1000), item_rule=lambda item: item.name != Wallets.value),
        ...
        "OS Emporium Health Rose #1" : LocationData(186, "Ossex Emporium", ShopPrice(cost=500), item_rule=lambda item: item.name != Wallets.value),
        "OS Emporium Health Rose #2" : LocationData(187, "Ossex Emporium", ShopPrice(cost=1000), item_rule=lambda item: item.name != Wallets.value),
        "OS Emporium Health Rose #3" : LocationData(188, "Ossex Emporium", ShopPrice(cost=1500)),
        "OS Emporium Joule Box #1" : LocationData(193, "Ossex Emporium", ShopPrice(cost=500), item_rule=lambda item: item.name != Wallets.value),
        ...
        "OS Emporium Trinket Bag #1" : LocationData(196, "Ossex Emporium", ShopPrice(cost=1500), item_rule=lambda item: item.name != Wallets.value),
        ...
        "OS Emporium Vial Pouch #1" : LocationData(189, "Ossex Emporium", ShopPrice(cost=1000), item_rule=lambda item: item.name != Wallets.value),
        ...
        "OS Legovich's Arms Whip" : LocationData(174, "Ossex Legovich's Arms", ShopPrice(cost=2000)),
        "OS Legovich's Arms Hammer" : LocationData(175, "Ossex Legovich's Arms", ShopPrice(cost=2000)),
        "OS Legovich's Arms Daggers" : LocationData(176, "Ossex Legovich's Arms", ShopPrice(cost=2000)),
        "OS Legovich's Arms Guardian Casket" : LocationData(178, "Ossex Legovich's Arms", ShopPrice(cost=2000)),
        "OS Legovich's Arms Battery Buster" : LocationData(177, "Ossex Legovich's Arms", ShopPrice(cost=2000)),
        ...
        "OS Station Underside Bell of Grace" : LocationData(158, "Ossex Station Underside Main", ShopPrice(cost=1000), item_rule=lambda item: item.name != Wallets.value),
