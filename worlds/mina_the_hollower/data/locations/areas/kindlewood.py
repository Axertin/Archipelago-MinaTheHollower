...
collectable_locations: dict[str, LocationData] = {
    "KW Campfire Chest": LocationData(340, "Kindlewood Overgrowth Bonfire Main"),
    ...
    "KW Torch Escort Bonestone": LocationData(339, "Kindlewood Behind Madd House", CanBurrow() & CanCarry()),
    "KW Gourdan Oozing Organ Reward": LocationData(335, "Kindlewood Farm Crossing Pumpkin Patch", HasTrinket(trinket=Trinkets.OOZING_ORGAN.value)),
    ...
    "KW Shack Chest": LocationData(342, "Kindlewood Farm Crossing Shack", HasReachingSideArm() & CanBurrow()),
