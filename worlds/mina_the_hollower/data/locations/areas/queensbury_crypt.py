...
collectable_locations: dict[str, LocationData] = {
    ...
    "EH Carry Head QB Chest" : LocationData(238, "Eastern Heath East Corner", RepairedGenerator(event=QUEENSBURY_CRYPT_DATA) & HasKear(kear=SingleKears.MOURNERS_MILE_AFTER_GENERATOR_KEAR.value) & CanClimb() & CanCarry()),
    "MM Knight's Stand Bonestone": LocationData(303, "Mourner's Mile Knight's Guard Hill", CanCarry()),
}
