...
collectable_locations: dict[str, LocationData] = {
    "SO Commons Ossex Entry Wall Left Chest" : LocationData(270, "Ossex Entry Western Wall Chest", CanJumpTiles(distance=5, has_wall=True)),
    "SO Commons Ossex Entry Wall Right Chest" : LocationData(266, "Ossex Entry Eastern Wall Chest"),
    "SO Commons Bounce Chest" : LocationData(264, "Southern Outskirts Commons Main", CanBurrow() & CanBounce()),
    ...
    "SO Pit Room Bonestone" : LocationData(261, "Southern Outskirts Commons Southern Pit Room Main", CanJumpTiles(distance=5, has_wall=True) & CanBurrow()),
    "SO Western Wilds Entrance Chest" : LocationData(267, "Southern Outskirts Commons Western Pit Room Main", item_rule=lambda item: item.name != Wallets.WALLET_SIZE.value),
