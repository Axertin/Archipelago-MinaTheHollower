...
collectable_locations: dict[str, LocationData] = {
    ...
    "SO Cave Network Side Room Chest" : LocationData(264, "Southern Outskirts",
             CanJumpOneTile() & CanBlossomBounce() & CanBurrow() & Has("SO Cave Network Side Room Chest Kear")),
    ...
    "SO Commons Chest" : LocationData(267, "Southern Outskirts", CanJumpOneTile() & CanBlossomBounce() & CanBurrow()),
    ...
    "Bonestone_04" : LocationData(271, "Southern Outskirts"),
    "SO Poppit Keri" : LocationData(272, "Southern Outskirts",CanJumpOneTile() & CanBlossomBounce() & CanBurrow() ),
    "SO Poppit Kear" : LocationData(273, "Southern Outskirts",CanJumpOneTile() & CanBlossomBounce() & CanBurrow() ),
