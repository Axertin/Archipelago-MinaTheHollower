...
collectable_locations: dict[str, LocationData] = {
    ...
    "BB Calcified Caves Bonestone": LocationData(76, "Bone Beach Calcified Cage"),
    ...
    "BB Worm's Spine Battery Buster": LocationData(75, "Bone Beach Worms Back Chest", CanBounce()),
