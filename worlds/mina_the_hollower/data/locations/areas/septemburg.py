...
collectable_locations: dict[str, LocationData] = {
    "SB Launch Pad Secret Room #1 Chest": LocationData(91, "Septemburg Withered Farms Hills Maze", CanBounce()),
    "SB Launch Pad Secret Room #2 Kear": LocationData(89, "Septemburg Withered Farms Secret Springs", CanBounce()),
    ...
    "SB Hidden Crop Thresher Room Chest": LocationData(90, "Septemburg Tractor Chase", CanBounce() & CanBurrow()),
    ...
    "SB Below Crow Town Gazeworm Eye": LocationData(104, "Septemburg Crow Town Tunnel Top", HasFishingRod()),
    ...
    "SB Galloway Room Chest": LocationData(100, "Septemburg Tangled Woods Kid Room", CanBurrow() & CanBounce()),
