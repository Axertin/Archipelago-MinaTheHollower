...
collectable_locations: dict[str, LocationData] = {
    ...
    "NB Guard Room Trinket" : LocationData(47, "Nox's Bayou Waterfall Trinket"),
    "NB First Flooder Chest" : LocationData(39, "Nox's Bayou Lily Full Pump Room"),
    "NB Water Bugs Chest" : LocationData(38, "Nox's Bayou Shallow Pool"),
    "NB Lagoon Unflooded Dark Room Chest" : LocationData(42, "Nox's Bayou Big Lagoon Dark"),
    "NB Lagoon Flooded Side Room Trinket" : LocationData(40, "Nox's Bayou Big Lagoon East Side Room"),
    ...
    "NB Plant Pond Cave Chest" : LocationData(35, "Nox's Bayou Thick Plant Pond Cave"),
    "NB Thick Thicket Chest" : LocationData(36, "Nox's Bayou Twin Thicket"),
    "NB Thicket Hidden Cave Chest" : LocationData(44, "Nox's Bayou Canopy Bridge Cave"),
    "NB Grate Lake Chest" : LocationData(41, "Nox's Bayou Tainted Lair Grate Bridge"),
    "NB Nox's Beast Fight Reward" : LocationData(34, "Nox's Bayou Tainted Lair Arena", CanSwim()),
