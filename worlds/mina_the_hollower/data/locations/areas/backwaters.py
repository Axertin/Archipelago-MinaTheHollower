...
collectable_locations: dict[str, LocationData] = {
    ...
    "BW Fish Fleeper": LocationData(299, "Backwaters Fishing Hole", HasFishingRod()),
    "BW Fishing Hole Thalassion": LocationData(302, "Backwaters Fishing Hole", HasFishingRod() & CanSwim() & (Has(Trinkets.TUNNELING_CODEX.value) | Has(FishingUpgrades.FISHING_ROD.value, count=2))),
