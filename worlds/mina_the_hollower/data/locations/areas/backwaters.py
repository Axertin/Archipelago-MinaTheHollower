...
collectable_locations: dict[str, LocationData] = {
    ...
    "BW Fishing Hole Gilded Rod": LocationData(301, "Backwaters Fishing Hole", HasRepairedGeneratorCount(count=6) & HasFishingRod() & CanSwim() & (HasTrinket(trinket=Trinkets.TUNNELING_CODEX.value) | Has(FishingUpgrades.FISHING_ROD.value, count=2))),
}
