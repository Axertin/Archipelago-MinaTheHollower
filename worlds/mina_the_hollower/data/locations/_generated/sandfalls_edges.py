...
transitions: dict[str, Transition] = {
    ...
    'Sandfalls Miners Den Entrance East Transition': Transition('Sandfalls Miners Den Entrance', 'Sandfalls Miners Den Path', DirectionType.EAST, TransitionType.SCREENS, CanClimb()),
    'Sandfalls Miners Den Entrance Exit': Transition('Sandfalls Miners Den Entrance', 'Sandfalls Sifted Sands', DirectionType.NORTH, TransitionType.STAIRS, True_()),
    ...
    'Sandfalls Miners Den Path West Transition': Transition('Sandfalls Miners Den Path', 'Sandfalls Miners Den Entrance', DirectionType.WEST, TransitionType.SCREENS, CanClimb()),
