...
connections: dict[str, RegionConnection] = {
    ...
    'Kindlewood Overgrowth Entry Main_Kindlewood Overgrowth Entry Upper Left': RegionConnection('Kindlewood Overgrowth Entry Main', 'Kindlewood Overgrowth Entry Upper Left'),
...
transitions: dict[str, Transition] = {
    ...
    'Kindlewood Farm Crossing South Burrow': Transition('Kindlewood Farm Crossing', 'Kindlewood Wallowers Path', DirectionType.SOUTH, TransitionType.BURROW),
    'Kindlewood Farm Crossing West Transition': Transition('Kindlewood Farm Crossing', 'Kindlewood School Yard', DirectionType.WEST, TransitionType.SCREENS),
    'Kindlewood Farm Tomato Pipe': Transition('Kindlewood Farm Tomato', 'Kindlewood Farm Crossing Pumpkin Patch', DirectionType.OVERWORLD, TransitionType.DO_NOT_RANDOMIZE_ENTRANCE, CanBurrow()),
    ...
    'Kindlewood Overgrowth Behind Residence West Transition': Transition('Kindlewood Overgrowth Behind Residence', 'Kindlewood Overgrowth Bonfire Top', DirectionType.WEST, TransitionType.SCREENS),
    ...
    'Kindlewood Overgrowth Bonfire Main East Transition': Transition('Kindlewood Overgrowth Bonfire Main', 'Kindlewood Overgrowth Residence Yard', DirectionType.EAST, TransitionType.SCREENS),
    'Kindlewood Overgrowth Bonfire Top East Transition': Transition('Kindlewood Overgrowth Bonfire Top', 'Kindlewood Overgrowth Behind Residence', DirectionType.EAST, TransitionType.SCREENS),
    ...
    'Kindlewood Overgrowth Residence Barn Geyser_Down': Transition('Kindlewood Overgrowth Residence Barn', 'Kindlewood Overgrowth Residence Basement', DirectionType.OVERWORLD, TransitionType.GEYSER_DOWN, CanBurrow() & CanCarry()),
    'Kindlewood Overgrowth Residence Basement Geyser_Up': Transition('Kindlewood Overgrowth Residence Basement', 'Kindlewood Overgrowth Residence Barn', DirectionType.OVERWORLD, TransitionType.GEYSER_UP, CanBurrow()),
    'Kindlewood Overgrowth Residence Yard Doors': Transition('Kindlewood Overgrowth Residence Yard', 'Kindlewood Overgrowth Residence Barn', DirectionType.NORTH, TransitionType.DOORS),
    'Kindlewood Overgrowth Residence Yard West Transition': Transition('Kindlewood Overgrowth Residence Yard', 'Kindlewood Overgrowth Bonfire Main', DirectionType.WEST, TransitionType.SCREENS),
    'Kindlewood Rail Tunnel Tracks West Transition': Transition('Kindlewood Rail Tunnel Tracks', 'Kindlewood Train Tracks', DirectionType.WEST, TransitionType.SCREENS),
    'Kindlewood School Backyard Doors': Transition('Kindlewood School Backyard', 'Kindlewood School Side', DirectionType.NORTH, TransitionType.DOORS),
    'Kindlewood School Backyard Stairs': Transition('Kindlewood School Backyard', 'Septemburg Wastewater Canal Well Entrance', DirectionType.NORTH, TransitionType.STAIRS),
    'Kindlewood School Doors': Transition('Kindlewood School', 'Kindlewood School Yard', DirectionType.SOUTH, TransitionType.DOORS),
    'Kindlewood School Side Doors': Transition('Kindlewood School Side', 'Kindlewood School Backyard', DirectionType.SOUTH, TransitionType.DOORS),
    'Kindlewood School Side East Burrow': Transition('Kindlewood School Side', 'Kindlewood School', DirectionType.EAST, TransitionType.BURROW),
    'Kindlewood School West Burrow': Transition('Kindlewood School', 'Kindlewood School Side', DirectionType.WEST, TransitionType.BURROW),
    'Kindlewood School Yard Doors': Transition('Kindlewood School Yard', 'Kindlewood School', DirectionType.NORTH, TransitionType.DOORS),
    'Kindlewood School Yard East Transition': Transition('Kindlewood School Yard', 'Kindlewood Farm Crossing', DirectionType.EAST, TransitionType.SCREENS),
    'Kindlewood School Yard West Area Transition': Transition('Kindlewood School Yard', 'Septemburg Withered Farms Start East', DirectionType.WEST, TransitionType.AREA_SCREENS),
    'Kindlewood Train Tracks East Transition': Transition('Kindlewood Train Tracks', 'Kindlewood Rail Tunnel Tracks', DirectionType.EAST, TransitionType.SCREENS),
    "Kindlewood Wallower's Path Cliff Bush East Burrow": Transition("Kindlewood Wallower's Path Cliff Bush", 'Kindlewood Overgrowth Bonfire Left', DirectionType.EAST, TransitionType.BURROW),
    'Kindlewood Wallowers Path North Burrow': Transition('Kindlewood Wallowers Path', 'Kindlewood Farm Crossing', DirectionType.NORTH, TransitionType.BURROW),
}
