...
connections: dict[str, RegionConnection] = {
    ...
    "Mourner's Mile Spike Hell Mourner_Mourner's Mile Spike Hell Sandfall": RegionConnection("Mourner's Mile Spike Hell Mourner", "Mourner's Mile Spike Hell Sandfall", (HasTrinket(trinket=Trinkets.SPIKE_SPURS.value) & Has(PlayerUpgrades.HEALTH_ROSE.value, count=6)) | (Has(Sidearms.MIST_JAR.value) & Has(PlayerUpgrades.JOULE_BOX.value, count=2))),
