...
transitions: dict[str, Transition] = {
    ...
    "Mourner's Mile Knight's Rest Main West Area Transition": Transition("Mourner's Mile Knight's Rest Main", 'Eastern Hearth Mourners Gate', DirectionType.WEST, TransitionType.SCREENS, True_()),
    ...
    "Mourner's Mile Statue Room Main West Transition": Transition("Mourner's Mile Statue Room Main", 'Eastern Hearth East Corner Cliff', DirectionType.WEST, TransitionType.SCREENS, True_()),
