...
transitions: dict[str, Transition] = {
    ...
    'Ossex High Street Main East Area Transition': Transition('Ossex High Street Main', 'Eastern Hearth Grassland', DirectionType.EAST, TransitionType.AREA_SCREENS, True_()),
