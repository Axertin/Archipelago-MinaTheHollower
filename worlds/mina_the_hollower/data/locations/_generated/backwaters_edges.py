...
connections: dict[str, RegionConnection] = {
    ...
    'Backwaters Lower Swamp Fishing_Backwaters Lower Swamp': RegionConnection('Backwaters Lower Swamp Fishing', 'Backwaters Lower Swamp', CanJumpTiles(distance=5) | HasKear(kear=SingleKears.BACKWATERS_FISHING_KEAR.value)),
    ...
    'Backwaters Lower Swamp_Backwaters Lower Swamp Fishing': RegionConnection('Backwaters Lower Swamp', 'Backwaters Lower Swamp Fishing', CanJumpTiles(distance=5) | HasKear(kear=SingleKears.BACKWATERS_FISHING_KEAR.value)),
    ...
    'Backwaters Upper Swamp Back_Backwaters Upper Swamp Fenced': RegionConnection('Backwaters Upper Swamp Back', 'Backwaters Upper Swamp Fenced', CanJumpTiles(distance=4, has_wall=True) | CanSwim()),
    ...
    'Backwaters Upper Swamp Fenced_Backwaters Upper Lantern Pad': RegionConnection('Backwaters Upper Swamp Fenced', 'Backwaters Upper Lantern Pad', CanJumpTiles(distance=4) | (CanSwim() & CanBurrow)),
    'Backwaters Upper Swamp Fenced_Backwaters Upper Swamp Back': RegionConnection('Backwaters Upper Swamp Fenced', 'Backwaters Upper Swamp Back', CanJumpTiles(distance=5) | (CanSwim() & CanBurrow)),
