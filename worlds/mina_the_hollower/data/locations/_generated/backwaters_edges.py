...
connections: dict[str, RegionConnection] = {
    ...
    'Backwaters Bayou Falls West_Backwaters Bayou Falls East': RegionConnection('Backwaters Bayou Falls West', 'Backwaters Bayou Falls East', CanJumpTiles(distance=2, over_water=True) | CanSwim()),
    ...
    'Backwaters Lower Swamp Fishing_Backwaters Lower Swamp': RegionConnection('Backwaters Lower Swamp Fishing', 'Backwaters Lower Swamp', CanJumpTiles(distance=5, over_water=True) | HasKear(kear=SingleKears.BACKWATERS_FISHING_KEAR.value)),
    ...
    'Backwaters Lower Swamp Shanty Band_Backwaters Lower Swamp Bayou Entrance': RegionConnection('Backwaters Lower Swamp Shanty Band', 'Backwaters Lower Swamp Bayou Entrance', CanJumpTiles(distance=4, over_water=True) | CanSwim()),
    'Backwaters Lower Swamp Station Entrance_Backwaters Lower Swamp': RegionConnection('Backwaters Lower Swamp Station Entrance', 'Backwaters Lower Swamp', CanJumpTiles(distance=2, over_water=True) | CanSwim()),
    ...
    'Backwaters Lower Swamp_Backwaters Lower Swamp Fishing': RegionConnection('Backwaters Lower Swamp', 'Backwaters Lower Swamp Fishing', CanJumpTiles(distance=5, over_water=True) | HasKear(kear=SingleKears.BACKWATERS_FISHING_KEAR.value)),
    ...
    'Backwaters Lower Swamp_Backwaters Lower Swamp Station Entrance': RegionConnection('Backwaters Lower Swamp', 'Backwaters Lower Swamp Station Entrance', CanJumpTiles(distance=2, over_water=True) | CanSwim()),
    'Backwaters Pinky Back Pond Board_Backwaters Pinky Back Pond Lawn': RegionConnection('Backwaters Pinky Back Pond Board', 'Backwaters Pinky Back Pond Lawn', CanJumpTiles(distance=3, has_wall=True, over_water=True) | CanSwim()),
    'Backwaters Pinky Back Pond Lawn_Backwaters Pinky Back Pond Board': RegionConnection('Backwaters Pinky Back Pond Lawn', 'Backwaters Pinky Back Pond Board', CanJumpTiles(distance=3, has_wall=True, over_water=True) | CanSwim()),
    ...
    'Backwaters Upper Lantern Pad_Backwaters Upper Swamp East': RegionConnection('Backwaters Upper Lantern Pad', 'Backwaters Upper Swamp East', CanJumpTiles(distance=3, over_water=True) | CanSwim()),
    ...
    'Backwaters Upper Swamp Back_Backwaters Upper Swamp Entrance': RegionConnection('Backwaters Upper Swamp Back', 'Backwaters Upper Swamp Entrance', CanJumpTiles(distance=2, over_water=True)),
    'Backwaters Upper Swamp Back_Backwaters Upper Swamp Fenced': RegionConnection('Backwaters Upper Swamp Back', 'Backwaters Upper Swamp Fenced', CanJumpTiles(distance=4, has_wall=True, over_water=True) | CanSwim()),
    'Backwaters Upper Swamp East_Backwaters Upper Lantern Pad': RegionConnection('Backwaters Upper Swamp East', 'Backwaters Upper Lantern Pad', CanJumpTiles(distance=3, over_water=True) | CanSwim()),
    'Backwaters Upper Swamp East_Backwaters Upper Swamp Lily': RegionConnection('Backwaters Upper Swamp East', 'Backwaters Upper Swamp Lily', CanJumpTiles(distance=2, over_water=True) | CanSwim()),
    ...
    'Backwaters Upper Swamp Fenced_Backwaters Upper Lantern Pad': RegionConnection('Backwaters Upper Swamp Fenced', 'Backwaters Upper Lantern Pad', CanJumpTiles(distance=4, over_water=True) | (CanSwim() & CanBurrow())),
    'Backwaters Upper Swamp Fenced_Backwaters Upper Swamp Back': RegionConnection('Backwaters Upper Swamp Fenced', 'Backwaters Upper Swamp Back', CanJumpTiles(distance=5, over_water=True) | (CanSwim() & CanBurrow())),
    ...
    'Backwaters Upper Swamp Lily_Backwaters Upper Swamp East': RegionConnection('Backwaters Upper Swamp Lily', 'Backwaters Upper Swamp East', CanJumpTiles(distance=2, over_water=True) | CanSwim()),
    'Backwaters Upper Swamp Waterfall_Backwaters Upper Swamp Back': RegionConnection('Backwaters Upper Swamp Waterfall', 'Backwaters Upper Swamp Back', CanJumpTiles(distance=2, over_water=True)),
}
