...
transitions: dict[str, Transition] = {
    ...
    "Backwaters Lucky's Lair Pipe": Transition("Backwaters Lucky's Lair", "Nox's Bayou Bog Pipe Room", DirectionType.OVERWORLD, TransitionType.DO_NOT_RANDOMIZE_ENTRANCE, True_()),
