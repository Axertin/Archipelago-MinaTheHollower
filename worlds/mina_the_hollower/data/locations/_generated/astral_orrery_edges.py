...
connections: dict[str, RegionConnection] = {
    ...
    "Astral Orrery Mirror's End Blue Stairs_Astral Orrery Mirror's End": RegionConnection("Astral Orrery Mirror's End Blue Stairs", "Astral Orrery Mirror's End", Has(AstralPlatforms.BLUE_ASTRAL_PLATFORMS.value) | CanJumpTiles(distance=5, has_wall=True)),
    ...
    "Astral Orrery Mirror's End_Astral Orrery Mirror's End Blue Stairs": RegionConnection("Astral Orrery Mirror's End", "Astral Orrery Mirror's End Blue Stairs", Has(AstralPlatforms.BLUE_ASTRAL_PLATFORMS.value) | CanJumpTiles(distance=5, has_wall=True)),
...
transitions: dict[str, Transition] = {
    'Astral Orrery Bayou Mirror': Transition('Astral Orrery Bayou Mirror', "Nox's Bayou Moonlit Mirror", DirectionType.ASTRAL, TransitionType.MIRRORS, True_()),
    'Astral Orrery Bone Beach Mirror': Transition('Astral Orrery Bone Beach Mirror', 'Bone Beach Worms Back Hide Tent', DirectionType.ASTRAL, TransitionType.MIRRORS, True_()),
    ...
    'Astral Orrery Cog Chamber End Mirror': Transition('Astral Orrery Cog Chamber End', 'Astral Orrery Stellarium Cog Switch', DirectionType.ASTRAL, TransitionType.MIRRORS, True_()),
    'Astral Orrery Cog Chamber Pipe': Transition('Astral Orrery Cog Chamber', 'Astral Orrery Stellarium', DirectionType.ASTRAL, TransitionType.DO_NOT_RANDOMIZE_ENTRANCE, True_()),
    'Astral Orrery Coltrane Peak Mirror': Transition('Astral Orrery Coltrane Peak Mirror', 'Coltrane Peak Frozen Mirror Room', DirectionType.ASTRAL, TransitionType.MIRRORS, True_()),
    'Astral Orrery Gravity Zone End Mirror': Transition('Astral Orrery Gravity Zone End', 'Astral Orrery Stellarium Gravity Switch', DirectionType.ASTRAL, TransitionType.MIRRORS, True_()),
    'Astral Orrery Gravity Zone Pipe': Transition('Astral Orrery Gravity Zone', 'Astral Orrery Stellarium', DirectionType.ASTRAL, TransitionType.DO_NOT_RANDOMIZE_ENTRANCE, True_()),
    'Astral Orrery Gravity Zone_Astral Orrery Gravity Zone End': Transition('Astral Orrery Gravity Zone', 'Astral Orrery Gravity Zone End', DirectionType.ASTRAL, TransitionType.DO_NOT_RANDOMIZE_ENTRANCE, True_()),
    'Astral Orrery Hall Of Scholars End Mirror': Transition('Astral Orrery Hall Of Scholars End', 'Astral Orrery Stellarium Scholars Switch', DirectionType.ASTRAL, TransitionType.MIRRORS, True_()),
    ...
    "Astral Orrery Mirror's End East Purple Burrow": Transition('Astral Orrery Coltrane Peak Mirror', 'Astral Orrery Under Coltrane Peak Mirror', DirectionType.EAST, TransitionType.BURROW, (Has(AstralPlatforms.PURPLE_ASTRAL_PLATFORMS.value) | CanJumpTiles(distance=5, has_wall=True)) & CanBurrow()),
    ...
    "Astral Orrery Mirror's End Moving Stairs Stairs": Transition("Astral Orrery Mirror's End Moving Stairs", 'Astral Orrery Stellarium', DirectionType.NORTH, TransitionType.STAIRS, True_()),
    ...
    "Astral Orrery Mirror's End Top North Burrow": Transition("Astral Orrery Mirror's End Top", "Astral Orrery Mirror's End Moving Platforms", DirectionType.NORTH, TransitionType.BURROW, True_()),
    ...
    'Astral Orrery Sealed Archive Congealed Chamber South Transition': Transition('Astral Orrery Sealed Archive Congealed Chamber', 'Astral Orrery Sealed Archive Hall', DirectionType.SOUTH, TransitionType.DO_NOT_RANDOMIZE_ENTRANCE, True_()),
    'Astral Orrery Sealed Archive Glass North Transition': Transition('Astral Orrery Sealed Archive Glass', 'Astral Orrery Sealed Archive Boxes', DirectionType.NORTH, TransitionType.DO_NOT_RANDOMIZE_ENTRANCE, True_()),
    'Astral Orrery Sealed Archive Glass South Transition': Transition('Astral Orrery Sealed Archive Glass', 'Astral Orrery Sealed Archive', DirectionType.SOUTH, TransitionType.DO_NOT_RANDOMIZE_ENTRANCE, True_()),
    'Astral Orrery Sealed Archive Hall North Transition': Transition('Astral Orrery Sealed Archive Hall', 'Astral Orrery Sealed Archive Congealed Chamber', DirectionType.NORTH, TransitionType.DO_NOT_RANDOMIZE_ENTRANCE, True_()),
    'Astral Orrery Sealed Archive Hall South Transition': Transition('Astral Orrery Sealed Archive Hall', 'Astral Orrery Sealed Archive Boxes', DirectionType.SOUTH, TransitionType.DO_NOT_RANDOMIZE_ENTRANCE, True_()),
    'Astral Orrery Sealed Archive Mirror': Transition('Astral Orrery Sealed Archive', 'Astral Orrery Stellarium Complete', DirectionType.ASTRAL, TransitionType.MIRRORS, True_()),
    'Astral Orrery Sealed Archive North Transition': Transition('Astral Orrery Sealed Archive', 'Astral Orrery Sealed Archive Glass', DirectionType.NORTH, TransitionType.DO_NOT_RANDOMIZE_ENTRANCE, True_()),
    'Astral Orrery Septemburg Mirror': Transition('Astral Orrery Septemburg Mirror', 'Septemburg Farm House', DirectionType.ASTRAL, TransitionType.MIRRORS, True_()),
    ...
    'Astral Orrery Starry Generator Stairs South Transition': Transition('Astral Orrery Starry Generator Stairs', 'Astral Orrery Sealed Archive Congealed Chamber', DirectionType.SOUTH, TransitionType.DO_NOT_RANDOMIZE_ENTRANCE, True_()),
    'Astral Orrery Starry Generator Stairs Stairs': Transition('Astral Orrery Starry Generator Stairs', 'Astral Orrery Starry Mirror Room', DirectionType.NORTH, TransitionType.STAIRS, True_()),
    'Astral Orrery Starry Mirror Room Mirror': Transition('Astral Orrery Starry Mirror Room', 'Ossex High Street Residence Mirror', DirectionType.ASTRAL, TransitionType.MIRRORS, True_()),
    'Astral Orrery Starry Mirror Room Stairs': Transition('Astral Orrery Starry Mirror Room', 'Astral Orrery Starry Generator Stairs', DirectionType.NORTH, TransitionType.STAIRS, True_()),
    'Astral Orrery Stellarium Cog Chamber Pipe': Transition('Astral Orrery Stellarium', 'Astral Orrery Cog Chamber', DirectionType.ASTRAL, TransitionType.DO_NOT_RANDOMIZE_ENTRANCE, True_()),
    'Astral Orrery Stellarium Cog Switch Mirror': Transition('Astral Orrery Stellarium Cog Switch', 'Astral Orrery Cog Chamber End', DirectionType.ASTRAL, TransitionType.MIRRORS, True_()),
    'Astral Orrery Stellarium Complete Mirror': Transition('Astral Orrery Stellarium Complete', 'Astral Orrery Sealed Archive', DirectionType.ASTRAL, TransitionType.MIRRORS, True_()),
    'Astral Orrery Stellarium Gravity Switch Mirror': Transition('Astral Orrery Stellarium Gravity Switch', 'Astral Orrery Gravity Zone End', DirectionType.ASTRAL, TransitionType.MIRRORS, True_()),
    ...
    'Astral Orrery Under Coltrane Peak Mirror West Burrow': Transition('Astral Orrery Under Coltrane Peak Mirror', 'Astral Orrery Coltrane Peak Mirror', DirectionType.WEST, TransitionType.BURROW, (Has(AstralPlatforms.PURPLE_ASTRAL_PLATFORMS.value) | CanJumpTiles(distance=5, has_wall=True)) & CanBurrow()),
}
