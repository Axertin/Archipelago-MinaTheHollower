...
transitions: dict[str, Transition] = {
    ...
    'Western Wilds Molten Dungeon Entrance Stairs': Transition('Western Wilds Molten Dungeon Entrance', 'Western Wilds Molten Foundry Dark', DirectionType.NORTH, TransitionType.STAIRS, True_()),
    ...
    'Western Wilds Molten Foundry Dark Stairs': Transition('Western Wilds Molten Foundry Dark', 'Western Wilds Molten Dungeon Entrance', DirectionType.NORTH, TransitionType.STAIRS, True_()),
