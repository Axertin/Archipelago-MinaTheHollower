...
area_id_to_map: dict[int, MapData] = {
    ...
    49: MapData(sb_fight, 70),
    51: MapData(sb_generator, 70),
    50: MapData(sb_wastewater, 71),
    94: MapData(sf_start, 73),
    93: MapData(sandfalls, 73),
    95: MapData(sf_station, 73),
    96: MapData(sf_ring, 74),
    ...
    31: MapData(bb_mine, 83),
    32: MapData(bb_depths, 84),
    33: MapData(bb_dark, 85),
    57: MapData(ctp_pass_bottom, 86),
    109: MapData(ctp_pass, 86),
    108: MapData(ctp_train, 87),
    119: MapData(ctp_maelstorm_cliff, 87),
    110: MapData(ctp_gorge, 88),
    111: MapData(ctp_woods, 91),
    114: MapData(ctp_rail, 92),
    112: MapData(ctp_cavern, 93),
    113: MapData(ctp_cavern_arena, 93),
    115: MapData(ctp_summit, 94),
    116: MapData(ctp_agnes, 95),
    117: MapData(ctp_maelstorm, 96),
    118: MapData(ctp_maelstorm_bottom, 96),
    121: MapData(ctp_generator, 96),
    100: MapData(ao_mirror, 97),
    103: MapData(ao_stellarium, 99),
    101: MapData(ao_cog, 100),
    106: MapData(ao_gravity, 102),
    104: MapData(ao_mutant, 103),
    105: MapData(ao_scholar, 104),
    98: MapData(ao_archive, 105),
    99: MapData(ao_exit, 105),
    107: MapData(ao_generator, 105),
    168: MapData(rm_foyer, 106),
    171: MapData(rm_foyer_butler, 106),
    169: MapData(rm_foyer_library, 106),
    170: MapData(rm_orphanage, 106),
    137: MapData(rm_washroom, 106),
    139: MapData(rm_hall, 106),
    127: MapData(rm_ballroom, 107),
    132: MapData(rm_meowstro, 107),
    140: MapData(rm_mimic, 107),
    134: MapData(rm_corridor, 108),
    133: MapData(rm_roof, 108),
    128: MapData(rm_greenhouse, 109),
    129: MapData(rm_rafters, 110),
    130: MapData(rm_gallery, 111),
    131: MapData(rm_servants, 111),
